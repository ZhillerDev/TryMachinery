...
由于 ubuntu22.04 默认自带了 python3.10 版本，很新，完全不需要更新，所以这里就不介绍对应的安装过程了
...
> 使用版本：ubuntu22.04 LTS

最新 22 版本的 ubuntu 已经默认自带了 iBus 输入法以及 fcitx 输入法，我们仅需要做出一些简单设置即可直接使用中文输入法

安装完毕后，依次点击  
右上角->设置->区域与语言->管理已安装的语言->键盘输入法系统->切换为 iBus（如果默认就是 iBus 那就不管）
切换完毕后，点击“应用到整个系统”
...
ubuntu 安装时默认的输入法叫做“汉语”，没有用，把他删了
